...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/square.svg
  String get square => 'assets/images/square.svg';

  /// File path: assets/images/welcome image.png
  AssetGenImage get welcomeImage =>
      const AssetGenImage('assets/images/welcome image.png');

  /// List of all assets
  List<dynamic> get values =>
      [apple, circle, facebook, google, square, welcomeImage];
}
